...
const Product = () => {
  ...
  return productData ? (
    <main>
      <Navbar />
      <section className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-col-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mt-6 pb-14 w-full">
